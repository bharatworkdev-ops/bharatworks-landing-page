...
const SignupPage = () => {
  ...
  const roleLabel = isEmployer ? "Employer" : "Labour";
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      login({
        ...
        role: isEmployer ? "employer" : "labour",
      });
      setIsLoading(false);
      ...
      >
        ...
        <div className="glass rounded-3xl p-8 md:p-10 border border-border-light">
          ...
          <div className="text-center mb-8">
            ...
            >
              <FaUser className="text-3xl text-action" />
            </motion.div>
            <h2 className="text-2xl md:text-3xl font-bold text-text-primary mb-2">
              Create Account
            </h2>
            <p className="text-text-secondary">
              Join BharatWork as a{" "}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <FaUser className="text-text-placeholder" />
                </div>
                <input
                  type="text"
                  name="name"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <FaPhone className="text-text-placeholder" />
                </div>
                <input
                  type="tel"
                  name="phone"
